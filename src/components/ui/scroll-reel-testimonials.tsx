...
const QUOTE_CLASSES =
  "m-0 text-lg sm:text-xl md:text-[22px] font-medium leading-[1.45] tracking-[-0.015em] text-[#EDE7DC]";
const AUTHOR_CLASSES =
  "m-0 text-sm sm:text-base font-semibold leading-[1.4] text-[#E8913C] tracking-wide uppercase";
...
function Cell() {
  return (
    <div
      aria-hidden="true"
      className="shrink-0 rounded-xl border border-white/10 bg-gradient-to-b from-white/5 to-white/0 blur-[1px] shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(220.99deg, rgba(232,145,60,0) 32%, rgba(232,145,60,0.6) 45%, rgba(232,145,60,0) 65%)",
        }}
      />
    </div>
  );
...
export function ScrollReelTestimonials({
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      className={cn(
        "relative flex w-full max-w-[1060px] flex-col items-stretch gap-6 overflow-hidden rounded-2xl border border-white/10 bg-[#101317] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] outline-none focus-visible:ring-2 focus-visible:ring-amber-500 md:min-h-[340px] md:flex-row md:items-center md:p-6",
        className
      )}
    >
      {/* Reel section */}
      <div
        aria-hidden="true"
        className="relative h-60 w-full shrink-0 self-center overflow-hidden rounded-xl bg-[#0A0C0E]/60 md:h-[300px] md:w-[360px]"
        style={{
          WebkitMaskImage:
      ...
      {/* Content section */}
      <div className="flex min-w-0 flex-1 flex-col justify-between self-stretch px-4 py-4 md:px-8 md:py-6">
        <div className="flex flex-col gap-4">
          {/* Amber Quote Icon */}
          <svg
            className="block h-10 w-10 text-[#E8913C]/80"
            viewBox="0 0 24 24"
            fill="currentColor"
            aria-hidden="true"
          >
          ...
          {/* Text stage with full available width */}
          <div
        ...
        {/* Controls - Prominent Buttons aligned cleanly */}
        <div className="mt-8 flex items-center gap-3">
          <button
            ...
            className="grid h-9 w-9 cursor-pointer place-items-center rounded-full border border-white/20 bg-white/5 text-[#EDE7DC] transition-all duration-200 hover:enabled:scale-105 hover:enabled:bg-[#E8913C] hover:enabled:border-[#E8913C] hover:enabled:text-black active:enabled:scale-95 disabled:cursor-default disabled:opacity-30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
          >
            <svg
              className="h-4 w-4"
              viewBox="0 0 12 12"
          ...
          <span className="ml-2 text-xs font-semibold tracking-wider text-white/40 uppercase">
